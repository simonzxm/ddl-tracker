/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: a42828049842d01091d0dadfbcd71d7a)
...
interface __BaseEnv_Env {
	...
	OIDC_POST_LOGIN_REDIRECT_URIS: string;
	OIDC_TRANSACTION_SECRET: string;
	TOKEN_PEPPER: string;
	SYNC_TOKEN_SECRET: string;
	MAINTAINER_BOOTSTRAP_TOKEN: string;
	AUTH_SERVER: Fetcher /* authserver */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENVIRONMENT" | "OIDC_ISSUER" | "OIDC_CLIENT_ID" | "OIDC_REDIRECT_URI" | "OIDC_POST_LOGIN_REDIRECT_URIS" | "OIDC_TRANSACTION_SECRET" | "TOKEN_PEPPER" | "SYNC_TOKEN_SECRET" | "MAINTAINER_BOOTSTRAP_TOKEN">> {}
}
